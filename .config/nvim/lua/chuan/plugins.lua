...
return packer.startup(function(use)
  ...
  -- Color Scheme
  use "folke/tokyonight.nvim" -- a bunch of colorschemes
  ...
  use "hrsh7th/cmp-nvim-lsp" -- used to integrate cmp with lsp
  ...
  use "JoosepAlviste/nvim-ts-context-commentstring" -- context aware comment engine
